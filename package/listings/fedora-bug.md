...
maintained one (35.8% -> 98.1% acceptance of real Kazakh)
...
An actively maintained replacement exists, GPL-3.0-or-later:
  ...
  release: https://github.com/iDynbek/hunspell-kk/releases/tag/v0.2.8

It accepts 98.1% of the same news text (flagging one word in 52 instead of
...
95.3% of realistic misspellings where the 2009 file catches 99.0% — the 2009
